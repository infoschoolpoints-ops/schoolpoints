...
- [ ] **בדיקת קריסות מוסד ביתר:** ניתוח קובץ ה‑DB והפקת גורם אפשרי לקריסות/שיבוש נתונים
...
- [ ] **פרסומות:** בזמן שיש חסימה (שבתות וחגים) גם הפרסומות לא יופיעו
...
- [ ] **אנטי‑ספאם (עמדה ציבורית):** תלמיד חסום לא אמור לראות את הודעת התלמיד הקודם; לנקות את הודעת הסטטוס בעת חסימה
