...
- [ ] **פריטיות מלאה לכל מסכי ניהול בווב** – תלמידים | ניהול מורים | דוחות | תצוגה ותוכן | הגדרות תצוגה (צבעים/צלילים/מטבעות) | הודעות | בונוס מיוחד | בונוס זמנים | בונוסים | חגים/חופשות | מערכת | הגדרות מערכת | לוגים | שדרוגים (שמות/פונקציונליות כמו במקומי)
  - [ ] טבלת השוואה מלאה בין פעולות במקומי לבין ה‑Web (בדיקת חוסרים ותיקון)
- [ ] **גרפיקה אחידה לכל המסכים** – הדר/פוטר, כפתורים בעיצוב אחיד עם אייקונים
  - [ ] יצירת סט אייקונים לכל שורת פעולה/כפתור בממשק הווב
- [ ] **אזור אישי מלא + שמירת התחברות** – הישארות מחובר עד יציאה, תפריט מוסד מלא
- [ ] **סופר אדמין (ווב)** – ניהול כל המוסדות, עריכה מלאה, כניסה למוסד ללא סיסמה, רישום מוסדות
...
- [ ] **יישור קו מלא לממשק המקומי** – הרשאות/כיתות למורה/הגבלות בונוסים/שדות נוספים

#### מסכים נדרשים (אין עדיפות – כולם קריטיים)
- [ ] **שדרוגים** – מלא
- [ ] **הודעות** – מלא
  - [x] יצירת טבלאות הודעות ב-tenant DB (static/threshold/news/ads/student)
  - [ ] API מלא לניהול הודעות + פרסומות (CRUD/תזמון/סידור/העלאת תמונה)
  - [ ] UI מלא למסך הודעות בווב (טאבים, טבלאות, פעולות כמו במקומי)
- [ ] **בונוסים** – מלא
- [ ] **בונוס מיוחד** – מלא
- [ ] **בונוס זמנים** – מלא
- [ ] **חגים/חופשות** – מלא
